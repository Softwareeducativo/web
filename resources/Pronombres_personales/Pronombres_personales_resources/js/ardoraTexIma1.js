...
if (e.which!=9){imaUp('Pronombres_personales_resources/media/imaLarge/ti_sign-up-icon.png');}});
$("#i_2").keydown(function(e) {
if (e.which!=9){imaUp('Pronombres_personales_resources/media/imaLarge/ti_Los-Pronombres-Personales-en-Ingles.jpg');}});
});
