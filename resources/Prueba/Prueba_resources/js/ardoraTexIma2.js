...
$("#goLeftBut").click(function() {window.open("Prueba1.htm","_self");});
$("#goLeftBut").keydown(function(e) {if (e.which != 9) {window.open("Prueba1.htm","_self");}});
...
if (e.which!=9){imaUp('Prueba_resources/media/imaLarge/ti_1-_Presentacion.jpj.jpg');}});
